...
const CommercialPaper = require('../../shipIT/contract/lib/transaction.js');
...
async function main() {
    ...
    try {
        ...
        const buyResponse = await contract.submitTransaction('buy', 'shipIT', '00001', 'shipIT', 'agency', '4900000', '2020-05-31');
